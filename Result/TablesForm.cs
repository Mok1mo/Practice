            ...
            if (e.KeyCode == Keys.Enter)
            {
                try
                {
                    if(tabControl.SelectedIndex == 0)
                    {
                        ...
                        {
                            if (workersDataGridView[1, i].Value.ToString() == searchTextBox.Text)
                            {
                                workersDataGridView.CurrentCell = workersDataGridView[1, i];
                                break;
                            }
                        }
                    }
                    if(tabControl.SelectedIndex == 1)
                    {
                        ...
                        {
                            if (studentsDataGridView[1, i].Value.ToString() == searchTextBox.Text)
                            {
                                studentsDataGridView.CurrentCell = studentsDataGridView[1, i];
                                break;
                            }
                        }
                    }
                    if(tabControl.SelectedIndex == 2)
                    {
                        ...
                        {
                            if (conscriptsDataGridView[1, i].Value.ToString() == searchTextBox.Text)
                            {
                                conscriptsDataGridView.CurrentCell = conscriptsDataGridView[1, i];
                                break;
                            }
                        }
                    }
